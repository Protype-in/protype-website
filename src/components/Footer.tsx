                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-20">
                    ...
                    <div className="lg:col-span-2 pr-8">
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-[#0a0a0f] border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-blue-500/10 hover:border-blue-500/30 transition-all duration-300 group">
                    ...
                    {links.map((col, i) => (
                        <div key={i}>
                            <h4 className="text-white font-semibold mb-6 tracking-wide text-sm uppercase">{col.title}</h4>
                            <ul className="space-y-4">
                                {col.items.map((link, j) => (
                                    <li key={j}>
                                        <a
                                            href={link.href}
                                            className="text-zinc-400 hover:text-white font-light text-sm transition-colors block relative group w-fit"
                                        >
                                            {link.label}
